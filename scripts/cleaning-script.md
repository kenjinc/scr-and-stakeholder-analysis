...
aggregated_data %>%
  ...
  scale_fill_gradient(low="azure2",high="seagreen",na.value="white",name="Number of Intervention-Receiving Institutions",guide=guide_colourbar(reverse=FALSE,title.position="top",title.hjust=0.5)) +
  xlab("") + 
  ylab("") +
  labs(caption="") +
