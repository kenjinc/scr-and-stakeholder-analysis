...
```
geom_signif(comparisons=list(c("Guest Experience","Campus Culture"),x_position=c(0.9,1.1)),annotation="***",color="black",size=0.3) +
  geom_signif(comparisons=list(c("Guest Experience","Food Pricing")),annotation="***",color="black",size=0.3) +
